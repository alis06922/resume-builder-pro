...
export const DashboardProfileEdit = () => {
    ...
    return <>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 text-sm">
                                        <span className="px-2 py-1 bg-primary-50 text-primary rounded">Step 1/5</span>
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 text-sm">
                                        <span className="px-2 py-1 bg-primary-50 text-primary rounded">Step 2/5</span>
                                        <span className="px-2 py-1 bg-green-50 text-green-700 rounded flex items-center gap-1">
                                            <CheckCircle2 className="w-4 h-4" /> Required
                                        </span>
                                    </div>
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 text-sm">
                                        <span className="px-2 py-1 bg-primary-50 text-primary rounded">Step 3/5</span>
                                        <span className="px-2 py-1 bg-green-50 text-green-700 rounded flex items-center gap-1">
                                            <CheckCircle2 className="w-4 h-4" /> Required
                                        </span>
                                    </div>
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 text-sm">
                                        <span className="px-2 py-1 bg-primary-50 text-primary rounded">Step 4/5</span>
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2 text-sm">
                                        <span className="px-2 py-1 bg-primary-50 text-primary rounded">Step 5/5</span>
                                        <span className="px-2 py-1 bg-yellow-50 text-yellow-700 rounded">Optional</span>
                                    </div>
                                </div>
                            </div>
        ...
        {isFormOpen && <ResumeForm onClose={() => setIsFormOpen(false)} />}
